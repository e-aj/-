      ...
      <el-card class="box-card">
        ...
        <el-table :data="userlist" border stripe>
          ...
          <el-table-column label="操作" width="180px" >
            <template slot-scope="scope">
              <!--修改按钮-->
              <el-button type="primary" icon="el-icon-edit" v-model="scope.row.mg_state"
                         size="mini" @click="showEditDialog(scope.row.id)"></el-button>
              <!--删除按钮-->
              <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeUserById(scope.row.id)"></el-button>
              <!--分配角色按钮-->
              <el-tooltip class="item" content="分配角色" placement="bottom" :enterable="false">
    ...
    export default {
      data() {
          ...
          var checkMobile = (rule,value,cb) =>{
            //验证手机的正则
            const regEmail =  /0?(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])[0-9]{8}/
